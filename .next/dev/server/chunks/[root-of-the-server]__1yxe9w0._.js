...
async function GET(request) {
    try {
        ...
        // Stats endpoint
        if (stats === 'true') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$skills$2d$reader$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSkillsStats"])());
        }
        // Single skill detail
        if (slug) {
            const skill = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$skills$2d$reader$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSkillBySlug"])(slug);
            if (!skill) {
        ...
        // List with filters
        let skills = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$skills$2d$reader$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllSkills"])();
        ...
        if (search) {
            ...
            skills = skills.filter((s)=>s.name.toLowerCase().includes(q) || s.description.toLowerCase().includes(q) || s.tags.some((t)=>t.toLowerCase().includes(q)));
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            total: skills.length,
            skills
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1yxe9w0._.js.map
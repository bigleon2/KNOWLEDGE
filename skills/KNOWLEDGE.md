...
- **Category** : ecosystem
- **Description** : Planification structurée des tâches — 4 modes, 15 étapes E1-E15, classification Type 1-4 (E3), règles d'or §1.8 (n°2 régénération post-installation, n°3 mise à jour à chaque nouvelle demande), disciplines d'ingénierie (orchestration §1.9 — source de vérité : SHARED §7), hook correct-work par phase E9-E14
...
- **Utilisé par** : correct-work (Étape 1, optionnel), autonomous-agent, Main (planification complète)
- **Dernière calibration** : 2026-09-07 (révision A12 : règles d'or n°2-n°3 — gestion du plan d'actions de session, directive utilisateur ; A11 : disciplines implantées en SHARED §7, triggers 9/9)
- **Statut** : stable
...
- **Dépend de** : gen-plan >= v3.7.0 (Étape 1, optionnel), clone-chat >= v2.0.0 (Mode CIBLE, §3.5), fullstack-dev >= v1.0.0 (projets web)
- **Utilisé par** : gen-plan (hooks par phase E9-E14), Main (vérification finale)
- **Dernière calibration** : 2026-09-06 (révision A10 : Description Optimization « erreurs, omissions, incohérences », itération-3 triggers 8/8 ; A9 : schéma evals unifié)
- **Statut** : stable
...
- **Utilisé par** : gen-plan (E15, archivage — leçon E23), autonomous-agent (persistance d'état)
- **Dernière calibration** : 2026-09-06 (10ᵉ clone scellé 776ff9c0…, révision prompt 1.0.3)
- **Statut** : stable

# PROMPT MAÎTRE — Installation du skill gen-plan v3.7.0

> **Version du prompt** : 1.2.0
> **Skill cible** : gen-plan v3.7.0
> **Date** : 2026-08-30
...
3. **§1 — Spécification fonctionnelle** : 4 modes, 15 étapes, normes N1-N3, règles d'or (§1.8), disciplines d'ingénierie (§1.9)
...
```json
{
  ...
  "evals": [
    ...
    {
      "id": "E6-regle-dor",
      "name": "Règle d'or : adaptation autonome",
      "input": "Un wipe inter-sessions ampute skills/ et la sortie d'un outil est perdue — que fait gen-plan ?",
      "expected_behavior": "Détection du blocage, contournement conforme aux conventions, journalisation worklog, continuité de l'objectif final",
      "expected_stop": false
    }
  ]
}
